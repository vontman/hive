...
CREATE TABLE IF NOT EXISTS `DBS` (
  ...
  `DB_LOCATION_URI` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `NAME` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `OWNER_NAME` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SERDE_PARAMS` (
  `SERDE_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(256) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `PARAM_VALUE` MEDIUMTEXT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TBLS` (
  ...
  `SD_ID` bigint(20) DEFAULT NULL,
  `TBL_NAME` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TAB_COL_STATS` (
 ...
 `DB_NAME` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
 `TABLE_NAME` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
 `COLUMN_NAME` varchar(767) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
